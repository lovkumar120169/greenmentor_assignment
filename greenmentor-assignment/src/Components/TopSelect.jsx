...
export const TopSelect = () => {
    const [date, Setdate] = useState("Jan’22 - Dec’23")
    return (
            ...
            <div className='top-select-container'>
                ...
                <Menu>
                    ...
                    <MenuList style={{ marginRight: "-20px" }}>
                        ...
                        <MenuItem onClick={() => Setdate("Jul’23 - Sep’23")}>Jul’23 - Sep’23</MenuItem>
                        <MenuItem onClick={() => Setdate("Oct’23 - Dec’23")}>Oct’23 - Dec’23</MenuItem>
                    </MenuList>
                </Menu>
