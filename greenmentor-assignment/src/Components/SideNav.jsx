                ...
                <div className='data-in-section-sidenav' >
                    ...
                    <div>
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                            <path fillRule="evenodd" clipRule="evenodd" d="M5 8L12 16L19 8H5Z" fill="white" />
                        </svg>
                    </div>
                    <div>
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                            <path fillRule="evenodd" cliRule="evenodd" d="M5 8L12 16L19 8H5Z" fill="white" />
                        </svg>
                    </div>
                </div>
